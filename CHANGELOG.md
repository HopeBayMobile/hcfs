...
v 2.0.3.0010
  ...
  To change configuration:
    1. Use "adb disable-verity" to allow remounting /system as rw. Reboot.
    2. Use "mount -o remount,rw /system" to remount /system as rw.   
    3. Use "adb pull /etc/hcfs.conf hcfs.conf" to pull configuration file.
    4. Edit configuration (might need to change cache size and log level too)
    5. Use "adb push hcfs.conf /etc/hcfs.conf" to overwrite configuration file.
    6. Reboot.
