...
#define CHECK_PACKAGE_BOOST_STATUS 54
#define ENABLE_BOOSTER 55
#define DISABLE_BOOSTER 56
#define TRIGGER_BOOST 57
#define TRIGGER_UNBOOST 58
#define CLEAR_BOOSTER_PKG 59
