...
HASH_LIST *create_hash_list(int32_t (*hash_ftn)(void *key),
		...
		int32_t table_size);
void *lookup_hash_list_entry(HASH_LIST *hash_list, void *key);
...
int32_t destroy_hash_list(HASH_LIST *hash_list);
...
//void hash_list_bucket_unlock(HASH_LIST *hash_list, void *key);
//void *hash_list_get_entry_data(HASH_LIST *hash_list, void *key)
