...
void test()
{
	...
	strcpy(googledrive_token, "Authorization:Bearer ya29.CjDNA5hROTgVGRj-syj8wNeZb0F09P4gIsCrFS465z6QpE93XOYdHF3xaGmCv9qjC7s");
	...
	int32_t ret = hcfs_gdrive_post_object(fptr, "test.jpg", &curl_handle, &info);
