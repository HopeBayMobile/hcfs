...
function(b,c,d){return this.optional(c)||a(b).match(/\b\w+\b/g).length>=d[0]&&b.match(/bw+b/g).length<d[1]},jQuery.validator.format("Please enter between {0} and {1} words."))})();jQuery.validator.addMethod("letterswithbasicpunc",function(a,b){return this.optional(b)||/^[a-z-.,()'\"\s]+$/i.test(a)},"Letters or punctuation only please");
jQuery.validator.addMethod("alphanumeric",function(a,b){return this.optional(b)||/^\w+$/i.test(a)},"Letters, numbers or underscores only please");
/* jslee addon -> */jQuery.validator.addMethod("alphanumericSpace",function(a,b){return this.optional(b)||/^[A-Za-z0-9 _]+$/i.test(a)},"Letters, numbers or underscores and space only please");
/* fred addon -> */jQuery.validator.addMethod("numeric",function(a,b){return this.optional(b)||/^\d+(\.\d{0,3})?$/.test(a)},"Number please");
