...
public class DownloadNotifier {
	...
	//guo: DownloadCompleteIntentService.java's displaySuccessResult() calls this method
	...
	//guo: DownloadCompleteIntentService.java's displayErrorResult() calls this method
	...
	//guo: DownloadNotifier.java internal use only
    ...
    private static PendingIntent createInstallPendingIntent(Context context, File updateFile) {
        ...
        installIntent.setAction(DownloadReceiver.ACTION_INSTALL_UPDATE);//guo: calls DownloadReceiver to reboot into recovery mode
