 ...
 * storage volume.
 */
public class HCFSVolumeSettings extends SettingsPreferenceFragment {
    ...
    static final String TAG = "HCFSStorageSettings";
    ...
    private String hcfsVolumeId;
    private VolumeInfo mVolume;
    private VolumeInfo hcfsVolume;
    ...
    private boolean isVolumeValid() {
        return (hcfsVolume != null) && (hcfsVolume.getType() == VolumeInfo.TYPE_HCFS)
    ...
    public void onCreate(Bundle icicle) {
        ...
        mVolumeId = getArguments().getString(VolumeInfo.EXTRA_PRIVATE_VOLUME);
        mVolume = mStorageManager.findVolumeById(mVolumeId);

        hcfsVolumeId = getArguments().getString(VolumeInfo.EXTRA_VOLUME_ID);
        hcfsVolume = mStorageManager.findVolumeById(hcfsVolumeId);
    ...
    public void update() {
        ...
        getActivity().setTitle(mStorageManager.getBestVolumeDescription(hcfsVolume));
    ...
    public static class RenameFragment extends DialogFragment {
        public static void show(HCFSVolumeSettings parent, VolumeInfo vol) {
    ...
    public static class ConfirmClearCacheFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    final HCFSVolumeSettings target = (HCFSVolumeSettings) getTargetFragment();
    ...
    private static class ClearCacheObserver extends IPackageDataObserver.Stub {
        private final HCFSVolumeSettings mTarget;
        private int mRemaining;

        public ClearCacheObserver(HCFSVolumeSettings target, int remaining) {
            mTarget = target;
